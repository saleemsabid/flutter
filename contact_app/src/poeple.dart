class Person {
  ...
  const Person(this.name, this.phone, this.picture, this.age, this.company);
}

final List<Person> people = _people
    .map((e) => Person(e['name'].toString(), e['phone'].toString(),
        e['picture'].toString(), e['age'].toString(), e['company'].toString()))
